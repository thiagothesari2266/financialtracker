...
export const mapAsaasImport = (record: PrismaAsaasImport): AsaasImport => ({
  ...
  asaasPaymentId: record.asaasPaymentId ?? null,
  asaasTransactionId: record.asaasTransactionId ?? null,
  asaasEntityType: record.asaasEntityType as AsaasImport['asaasEntityType'],
  direction: record.direction as AsaasImport['direction'],
  event: record.event,
